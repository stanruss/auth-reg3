 ...
 */
 ...
 if(isset($_GET['status']) and $_GET['status'] == 'ok')
 	echo '<div class="alert alert-success"><h4 class="text-center">Вы успешно зарегистрировались! Пожалуйста активируйте свой аккаунт!</h4></div>';
 
 //Выводим сообщение об удачной регистрации
 if(isset($_GET['active']) and $_GET['active'] == 'ok')
	echo '<div class="alert alert-success"><h4 class="text-center">Ваш аккаунт на http://bezramok-tlt.ru успешно активирован!</h4></div>';
